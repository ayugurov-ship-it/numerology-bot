...
Единственный точный факт — Солнце в {zodiac_name} (определено по дате рождения).
...
☀️ — Солнце в {zodiac_name}: ваши ключевые черты, жизненная цель, способ самовыражения. 3–4 предложения.

🔥 — Стихия {zodiac_element}: как она формирует ваш темперамент, реакции, способ действия. 2–3 предложения.

💞 — Любовь и отношения: стиль привязанности, что цените в партнёре, как проявляете чувства — исходя из качеств {zodiac_name}. 2–3 предложения.

💼 — Призвание и карьера: природные таланты, подходящие сферы, стиль работы. 2–3 предложения.

🪐 — Жизненные уроки: главные задачи развития для {zodiac_name} с числом пути {life_number}, зоны роста. 2–3 предложения.

🔢 — Число жизненного пути {life_number}: его глубинный смысл и как оно дополняет или корректирует качества {zodiac_name}. 2–3 предложения.
